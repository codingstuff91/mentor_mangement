<x-app-layout>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-row">
            <div class="p-4 bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 border-gray-300 w-1/3 bg-blue-100">
                <h2 class="text-3xl text-center">Nombre heures : {{ $total_heures }}</h2>
            </div>
            <div class="ml-4 p-4 bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 border-gray-300 w-2/3 bg-blue-100">
