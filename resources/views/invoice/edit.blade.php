            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class=" mx-auto p-4 bg-white border-b border-gray-200">
                    <form action="{{ route('invoice.update', $invoice->id) }}" method="post" class="flex flex-col">
                        ...
                        <select class="mt-2 rounded-lg" name="paid">
                            <option value="0" @if ($invoice->paid == 0) selected="selected" @endif>NON</option>
                            <option value="1" @if ($invoice->paid == 1) selected="selected" @endif>OUI</option>
                        </select>
