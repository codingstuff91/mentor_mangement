<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-row">
            <div class="bg-white overflow-hidden shadow-sm rounded-xl sm:w-1/2 lg:w-1/3">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl sm:w-1/2 lg:w-1/3 ml-4">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-row justify-center items-center">
