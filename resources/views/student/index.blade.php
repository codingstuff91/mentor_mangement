                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <div class="flex item-center justify-center">
                                                ...
                                                <div class="w-6 mr-2 transform text-red-500 hover:text-purple-500 hover:scale-110">
                                                    <a href="{{ route('student.destroy', $student) }}" onclick="return confirm('êtes-vous sur de vouloir le supprimer ?')">
                                                        <svg type="submit" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
